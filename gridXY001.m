...
close all
clear all
filename = 'frame1-B2N2-rota.dat'; % Primer frame del movie a analizar
...
nAtoms = 142;
fileMap0 = fopen('map0-B2N2.dat','w');
for i=1:nAtoms
...
sHor = '/home/ruben/malla/gridXY-B2N2/horizontales-B2N2-';
sVert = '/home/ruben/malla/gridXY-B2N2/verticales-B2N2-';
...
%A = importdata('nMA-B2N2');
A = nMA;
B = importdata('char-B2N2.dat');
C = importdata('frame1-B2N2-rota.dat');

fileID = fopen('mallanMA-B2N2.xyz','w');
fileID2 = fopen('mallanMA-B2N2.dat','w');
nAtoms = 142;
...
D = importdata('mallanMA-B2N2.dat');

fileMap = fopen('mapnMA-B2N2.dat','w');
for i=1:nAtoms
