...
s0 = '/home/toshiba/gridXY-B12N12b/'
for al=1:5000


   s = strcat('/home/toshiba/separados-B12N12b-zz-dat/frame', int2str(al), '.dat');
   filename = s;
   ...
   %   clear Ahr, s, s2, tAhr, toSpl;
      ...
      s = strcat(s0,'horizontales-B12N12b-', int2str(i));
   ...
   %   clear Ahr, s, s2, tAhr, toSpl;
      ...
      s = strcat(s0,'verticales-B12N12b-', int2str(i));
   ...
   al
   s2 = '/home/toshiba/mallaInter-B12N12b/frame';
