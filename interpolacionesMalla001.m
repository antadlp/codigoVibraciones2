...
s0 = '/home/antadlp/malla/gridXY-B6N6/'
for al=1:5000


   s = strcat('/home/antadlp/malla/separados-B6N6-zz-dat/frame', int2str(al), '.dat');
   filename = s;
   ...
   %   clear Ahr, s, s2, tAhr, toSpl;
      ...
      s = strcat(s0,'horizontales-B6N6-', int2str(i));
   ...
   %   clear Ahr, s, s2, tAhr, toSpl;
      ...
      s = strcat(s0,'verticales-B6N6-', int2str(i));
   ...
   al
   s2 = '/home/antadlp/malla/mallaInter-B6N6/frame';
