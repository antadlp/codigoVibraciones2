...
s0 = '/home/ruben/malla/gridXY-B2N2/'
for al=1:5000


   s = strcat('/home/ruben/malla/separados-B2N2-zz-dat/frame', int2str(al), '.dat');
   filename = s;
   ...
   %   clear Ahr, s, s2, tAhr, toSpl;
      ...
      s = strcat(s0,'horizontales-B2N2-', int2str(i));
   ...
   %   clear Ahr, s, s2, tAhr, toSpl;
      ...
      s = strcat(s0,'verticales-B2N2-', int2str(i));
   ...
   al
   s2 = '/home/ruben/malla/mallaInter-B2N2/frame';
