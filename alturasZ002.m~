...
filename = '/home/ruben/malla/movie-B2N2-zz.xyz';
fileID3 = fopen(filename, 'w');

for j = 1:5000
   
   s = '/home/ruben/malla/separados-B2N2-dat/'
   ...
   atoms = importdata('char-B2N2.dat');
   aGrid = importdata('mallanMA-B2N2.dat');
   mp = importdata('mapnMA-B2N2.dat');

   s = '/home/ruben/malla/separados-B2N2-zz-xyz/';
   s2 = '/home/ruben/malla/separados-B2N2-zz-dat/';
