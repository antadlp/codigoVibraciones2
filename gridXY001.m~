...
close all
clear all
filename = 'frame1-B6N6-rota.dat'; % Primer frame del movie a analizar
...
nAtoms = 142;
fileMap0 = fopen('map0-B6N6.dat','w');
for i=1:nAtoms
...
sHor = '/home/antadlp/malla/gridXY-B6N6/horizontales-B6N6-';
sVert = '/home/antadlp/malla/gridXY-B6N6/verticales-B6N6-';
...
%A = importdata('nMA-B6N6');
A = nMA;
B = importdata('char-B6N6.dat');
C = importdata('frame1-B6N6-rota.dat');

fileID = fopen('mallanMA-B6N6.xyz','w');
fileID2 = fopen('mallanMA-B6N6.dat','w');
nAtoms = 142;
...
D = importdata('mallanMA-B6N6.dat');

fileMap = fopen('mapnMA-B6N6.dat','w');
for i=1:nAtoms
